...
export default function Header({ title, author }: HeaderProps) {
  return (
    <div className="relative w-full mt-[64px] md:mt-[120px]">
      <div className="flex p-4 md:p-6 justify-between items-center border-b border-dashed" style={dashedBorder("y", "#CBCBCB", 1)}>
